...
import { base_uri_profile, url_link_diseases_ebbie, url_link_web_view_seek } from 'constants/BASE_URL';
...
function DetailDiseasesEbbie({route}) {
            ...
            <ScrollView backgroundColor="white">
                <View style={styles.container}>
                    <View style={{height: RFPercentage(100)}}>
                        <WebView
                            source={{uri: `${url_link_web_view_seek}${id}`}}
...
export default DetailDiseasesEbbie;
